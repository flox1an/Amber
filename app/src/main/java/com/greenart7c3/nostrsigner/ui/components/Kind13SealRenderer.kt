...
fun Kind13SealRenderer(
    ...
    // Seal events should have empty tags — warn if there are non-empty entries
    val hasUnexpectedTags = tags.any { it.isNotEmpty() }
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Surface(
            ...
            Text(
                text = "This event is signed with your real key and binds your identity to the enclosed message.",
        ...
        if (hasUnexpectedTags) {
            Surface(
                ...
                Text(
                    text = "Seal events should have empty tags.",
                    style = MaterialTheme.typography.bodySmall,
                    color = AmberColors.warning(),
                    fontWeight = FontWeight.Medium,
                    modifier = Modifier.padding(horizontal = 12.dp, vertical = 10.dp),
        ...
        val rawJson = remember(content, tags) { buildRawEventJson(13, content, tags) }
